...
def get_args():
    ...
    parser.add_argument('--new_thing_classes', nargs='+', default=["instrument"], help='New thing classes')
    ...
    parser.add_argument('--iter', type=int, default=3000, help='Max training iterations')
